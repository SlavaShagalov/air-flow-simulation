...
public:
  ...
  // getters
  T length() const;
  inline const T& x() const { return _coords[0]; }
  inline const  T &y() const { return _coords[1]; }
  inline const  T& z() const { return _coords[2]; }
  inline T& x() { return _coords[0]; }
  inline T& y() { return _coords[1]; }
  inline T& z() { return _coords[2]; }
